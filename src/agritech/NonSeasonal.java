...
public class NonSeasonal extends JFrame {
	...
	public ArrayList<Items>getItemList(){
		...
		String query="SELECT * FROM info_agri where season='Non-Seasonal'";
		Statement st;
		ResultSet rs;
		try {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NonSeasonal frame = new NonSeasonal();
	...
	public NonSeasonal() {
		...
		lblNonseasonalCrops = new JLabel("Non-Seasonal Crops :");
		...
		label.setIcon(new ImageIcon("src\\img\\corn.jpg"));
