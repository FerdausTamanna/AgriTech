...
public class ManipulationPage extends JFrame {
	...
	public ManipulationPage() {
		...
		btnAddNew.setIcon(new ImageIcon("src\\img\\images (1).jpg"));
		...
		btnDeleteUpdate.setIcon(new ImageIcon("src\\img\\edit.png"));
		...
		label.setIcon(new ImageIcon("src\\img\\happy-cartoon-field-3d-model-low-poly-max-obj (1).jpg"));
