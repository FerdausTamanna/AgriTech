...
public class MainPage extends JFrame {
	...
	public MainPage() {
		...
		lblWelcomeToAgritech.setBackground(new Color(0, 0, 0,80));
		lblWelcomeToAgritech.setForeground(new Color(0, 255, 0));
		lblWelcomeToAgritech.setOpaque(true);
		lblWelcomeToAgritech.setFont(new Font("Harrington", Font.BOLD, 56));
		lblWelcomeToAgritech.setHorizontalAlignment(SwingConstants.CENTER);
		lblWelcomeToAgritech.setBounds(10, 30, 963, 113);	
		...
		btnShow.setFont(new Font("Cooper Black",Font.PLAIN, 18));
		...
		btnAdmin.setFont(new Font("Cooper Black",Font.PLAIN, 18));
		...
		btnAbout.setFont(new Font("Cooper Black",Font.PLAIN, 18));
		...
		label.setIcon(new ImageIcon("src\\img\\spraying-soybean-field.jpg"));
