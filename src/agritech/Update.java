...
public class Update extends JFrame {
	...
	public Update() {
		...
		btnEdit.setIcon(new ImageIcon("src\\img\\edit.png"));
		...
		btnDelete.setIcon(new ImageIcon("src\\img\\63402720-trash-sign-illustration-white-icon-on-red-circle-.jpg"));
		...
		lblNewLabel.setIcon(new ImageIcon("src\\img\\Farm-fields-road-clouds_1920x1200.jpg"));
