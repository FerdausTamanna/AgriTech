...
public class Winter extends JFrame {
	...
	public Connection getConnection() {
		...
		try {
			...
			con =DriverManager.getConnection("jdbc:mysql://localhost/AgricultureDB?autoReconnect=true&useSSL=false", "root", "");
			return con;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public ArrayList<Items>getItemList(){
		...
		String query="SELECT * FROM info_agri where season='Winter'";
		Statement st;
		ResultSet rs;
		try {
	 ...
	 */
	public Winter() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("src\\img\\2-pic-sunflower-field.jpg"));
		...
		lblNonseasonalCrops = new JLabel("Winter Season Crops :");
		...
		btnBack.setIcon(new ImageIcon("src\\img\\i24_nav_back-512.png"));
		...
		label.setIcon(new ImageIcon("src\\img\\7b90f0cafb648396a416311c4b8056ebb53bba02_shutterstock_154023704.jpg"));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setBounds(0, 0, 1200, 661);
